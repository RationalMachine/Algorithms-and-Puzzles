...
3. Traverse the original linked list again
    and using the hash map adjust the next
...
class LinkedList
{
    ...
    public LinkedList.ReverseLinkedList.DeleteLinkedListNode clone()
    {
        ...
        return new LinkedList.ReverseLinkedList.DeleteLinkedListNode(map.get(this.head));
    }
}
...
class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        LinkedList.ReverseLinkedList.DeleteLinkedListNode list = new LinkedList.ReverseLinkedList.DeleteLinkedListNode(new Node(5));
        list.push(4);
        list.push(3);
        list.push(2);
        list.push(1);
        ...
        LinkedList.ReverseLinkedList.DeleteLinkedListNode clone = list.clone();
