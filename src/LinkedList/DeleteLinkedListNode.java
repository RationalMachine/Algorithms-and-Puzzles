...
f node to be deleted is root, simply delete it.
...
class DeleteLinkedListNode
{
    ...
    public static void main(String[] args)
    {
        ...
        LinkedList.ReverseLinkedList.DeleteLinkedListNode llist = new LinkedList.ReverseLinkedList.DeleteLinkedListNode();
